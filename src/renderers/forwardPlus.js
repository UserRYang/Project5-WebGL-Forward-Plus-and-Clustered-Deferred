...
export default class ForwardPlusRenderer extends BaseRenderer {
    ...
    render(camera, scene) {
        ...
        gl.uniform1f(this._shaderProgram.u_depth, camera.far - camera.near);
        ...
        gl.uniform1i(this._shaderProgram.u_numClusters, this._xSlices * this._ySlices * this._zSlices);
